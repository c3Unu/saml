...
namespace C3Unu\SimplerSaml\Http\Controllers;

use Illuminate\Contracts\Config\Repository as Config;
use Illuminate\Contracts\Events\Dispatcher as Event;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use C3Unu\SimplerSaml\Events\SamlLogin;
use C3Unu\SimplerSaml\Events\SamlLogout;
use C3Unu\SimplerSaml\Services\SamlAuth;

/**
 * Class SamlController
 *
 * @package C3Unu\SimplerSaml\Http\Controllers
 */
